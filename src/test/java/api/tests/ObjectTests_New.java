...
import api.endpoints.ObjectEndPoints_New;
...
public class ObjectTests_New {
	...
	public void createObjectTest() throws InterruptedException
	{
		...
		Response response= ObjectEndPoints_New.createObject(objPayload);
	...
	public void getObjectTest() throws InterruptedException
	{
		...
		Response response= ObjectEndPoints_New.getObject(objPayload.getId());		
	...
	public void updateObjectTest() throws InterruptedException
	{
		...
		Response response= ObjectEndPoints_New.updateObject(objPayload.getId(), objPayload);		
		System.out.println(response.asPrettyString());		
		int statusCode=response.getStatusCode();		
		Assert.assertEquals(statusCode, 200);			
	}
	...
	public void deleteObjectTest() throws InterruptedException
	{
		...
		Response response= ObjectEndPoints_New.deleteObject(objPayload.getId());		
		int statusCode=response.getStatusCode();		
		Assert.assertEquals(statusCode, 200);	
	...
	public void getALLObjectsTest() throws InterruptedException
	{
		...
		Response response= ObjectEndPoints_New.getALLObjects();		
